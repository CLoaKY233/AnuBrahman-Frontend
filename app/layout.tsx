  ...
  return (
    <html lang="en" className="dark scroll-smooth antialiased">
      ...
      >
        ...
        <div
          className="fixed inset-0 -z-49 bg-linear-to-br from-black via-[#0a0a0a] to-black"
          aria-hidden="true"
        />
        ...
        <div className="fixed inset-0 -z-47 overflow-hidden" aria-hidden="true">
          ...
          <div className="absolute -top-40 -left-40 w-[600px] h-[600px] bg-purple-950/15 rounded-full blur-[120px]" />

          {/* Bottom-right purple ambient */}
          <div className="absolute -bottom-40 -right-40 w-[500px] h-[500px] bg-purple-900/12 rounded-full blur-[100px]" />

          {/* Center subtle glow */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[400px] bg-purple-950/8 rounded-full blur-[140px]" />
        </div>
        ...
        <div className="fixed inset-0 -z-46 overflow-hidden pointer-events-none" aria-hidden="true">
          ...
          <div className="absolute top-1/4 left-1/3 w-96 h-96 bg-purple-500/8 rounded-full blur-[100px] animate-ambient-pulse" />

          {/* Pulsing glow - bottom area with delay */}
          <div className="absolute bottom-1/4 right-1/3 w-80 h-80 bg-purple-400/6 rounded-full blur-[90px] animate-ambient-pulse-delayed" />

          {/* Floating ambient light */}
          <div className="absolute top-1/2 left-1/4 w-64 h-64 bg-purple-600/5 rounded-full blur-[80px] animate-float-slow" />
        </div>
        ...
        <div className="fixed inset-0 -z-44 pointer-events-none" aria-hidden="true">
          ...
          <div className="absolute top-32 left-12 w-px h-40 bg-linear-to-b from-transparent via-white/8 to-transparent" />

          {/* Bottom-right horizontal line */}
          <div className="absolute bottom-32 right-16 w-32 h-px bg-linear-to-r from-transparent via-purple-400/12 to-transparent" />

          {/* Center diamond accent */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-8 h-8 border border-white/6 rotate-45" />

          {/* Additional corner accents */}
          <div className="absolute top-1/3 right-1/4 w-6 h-6 border border-purple-500/8 rounded-full" />
          <div className="absolute bottom-1/3 left-1/4 w-4 h-4 border border-purple-400/6" />
        </div>
